...
const handleDelete = async() => {
  ...
  return (
    ...
    <p className='font-medium text-base-content line-clanp-1'>{book.title}</p>
    </div>
    ...
    {/* EDIT */}
    <div className='tooltip-warning' data-tip="Edit book">
    ...
    <p className='py-4 text-base-content/70'> Are you sure you want to delete
