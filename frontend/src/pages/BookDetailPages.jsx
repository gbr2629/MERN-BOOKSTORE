  ...
  <div className='min-h-screen bg-base-200'>
    <div className='container mx-auto px-4 py-8'>
      <div className='max-w-2x1 mx-auto'>
        ...
        {/* HEADER */}
      <div className='flex items-center justify-betwween mb-6'>
      ...
      <div className='form-control mb-4'>
        ...
        <div className='form-control mb-4'>
          ...
          <input type='text' placeholder='Book author' className='input-input-bordered' value={book.author} onChange={(e) => setBook({...book,
        ...
        <div className='form-control mb-6'>
          ...
          <input type='numnber' placeholder='Year' className='input input-bordered' value={book.publishYear} onChange={(e) =>
